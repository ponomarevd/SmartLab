...
{
    public class InputPasswordViewModel : ViewModelBase
    {
        ...
        private async void ButtonClick(object sender)
        {
            ...
            switch (Password.Length)
            {
                ...
                case 4:
                    ...
                    string inputPassword = Preferences.Get("UserPassword", null);
                    if(inputPassword == Password)
                    {
                        if (Preferences.Get("UserName", null) != null &&
                            Preferences.Get("UserLastName", null) != null &&
                            Preferences.Get("UserMiddleName", null) != null &&
                            Preferences.Get("Birthday", null) != null &&
                            Preferences.Get("Gender", null) != null)
                        {
